...
CastError.prototype.formatMessage = function (model) {
  if (this.messageFormat != null) {
    let ret = this.messageFormat.replace('{KIND}', this.kind).replace('{VALUE}', this.stringValue).replace('{PATH}', this.path);
    ...
    let ret = 'Cast to ' + this.kind + ' failed for value ' + this.stringValue + ' at path "' + this.path + '"';
