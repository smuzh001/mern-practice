...
NativeCollection.prototype.onOpen = function () {
  const _this = this; // always get a new collection in case the user changed host:port
...
function iter(i) {
  NativeCollection.prototype[i] = function () {
    ...
    const lastArg = arguments[arguments.length - 1]; // If user force closed, queueing will hang forever. See #5664
