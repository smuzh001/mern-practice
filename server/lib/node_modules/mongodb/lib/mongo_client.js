...
const ReadPreference = require('./core/topologies/read_preference'); // Operations
...
function MongoClient(url, options) {
  ...
  const promiseLibrary = this.s.options.promiseLibrary || Promise; // Add the promise to the internal state
